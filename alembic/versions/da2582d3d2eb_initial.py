...
def upgrade():
    ...
    op.create_index(
        op.f("ix_documentationlink_package"),
        "documentationlink",
        ["package"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_offtopicchannelname_name"),
        "offtopicchannelname",
        ["name"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["actor_id"], ["user.id"], initially="DEFERRED", deferrable=True
        ),
        sa.ForeignKeyConstraint(
            ["user_id"], ["user.id"], initially="DEFERRED", deferrable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_infraction_actor_id"), "infraction", ["actor_id"], unique=False
    )
    op.create_index(
        op.f("ix_infraction_user_id"), "infraction", ["user_id"], unique=False
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["author_id"], ["user.id"], initially="DEFERRED", deferrable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_message_author_id"), "message", ["author_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_messagedeletioncontext_actor_id"),
        "messagedeletioncontext",
        ["actor_id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_nomination_user_id"), "nomination", ["user_id"], unique=False
    )
    op.create_table(
        "reminder",
        sa.Column("id", sa.Integer(), autoincrement=True, nullable=False),
    ...
    op.create_index(
        op.f("ix_reminder_author_id"), "reminder", ["author_id"], unique=False
    )
    op.create_table(
        "deletedmessage",
        sa.Column("id", sa.BigInteger(), nullable=False),
    ...
    op.create_index(
        op.f("ix_deletedmessage_deletion_context_id"),
        "deletedmessage",
        ["deletion_context_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["nomination_id"], ["nomination.id"], initially="DEFERRED", deferrable=True
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_nominationentry_actor_id"),
        "nominationentry",
        ["actor_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_nominationentry_nomination_id"),
        "nominationentry",
        ["nomination_id"],
        unique=False,
    )
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(
        op.f("ix_nominationentry_nomination_id"), table_name="nominationentry"
    )
    op.drop_index(op.f("ix_nominationentry_actor_id"), table_name="nominationentry")
    op.drop_table("nominationentry")
    op.drop_index(
        op.f("ix_deletedmessage_deletion_context_id"), table_name="deletedmessage"
    )
    ...
    op.drop_index(
        op.f("ix_messagedeletioncontext_actor_id"), table_name="messagedeletioncontext"
    )
